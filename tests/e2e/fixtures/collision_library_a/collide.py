...
the same base stable namespace and exercise LibraryManager._claim_stable_namespace's collision
detection across two real libraries, not just two files inside one library.
"""
