...
class BoundaryNode(DataNode):
    ...
    def process(self) -> None:
        # Two engine-owned answers, neither of which this module could compute for itself without
        ...
        self.parameter_output_values["run_summary"] = runner.load_and_run(self.execution_device)
