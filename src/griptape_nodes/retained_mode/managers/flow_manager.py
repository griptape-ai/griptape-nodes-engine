...
class FlowManager(EngineScoped):
    ...
    def on_extract_flow_commands_from_image_metadata(  # noqa: PLR0911, PLR0912, C901
        ...
        try:
            ...
            display_candidates = [
                self.engine.library_manager.get_module_display_name(module_name) for module_name in e.candidate_modules
            ]
            ...
            display_name = self.engine.library_manager.get_module_display_name(missing_module)
            logger.debug(
