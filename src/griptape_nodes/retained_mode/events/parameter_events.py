...
class AddParameterToNodeRequest(RequestPayload):
    ...
    Args:
        ...
        traits: Trait identity and state, as [{"trait_name": str, "trait_module": str, "trait_state": dict, "trait_callbacks": dict[str, str]}]. "trait_callbacks" is omitted for a trait with no nameable callbacks.
    ...
    # [{"trait_name": str, "trait_module": str, "trait_state": dict, "trait_callbacks": dict[str, str]}], as
    # produced by Parameter.trait_states(). "trait_callbacks" is omitted for a trait with no nameable callbacks.
