...
!!! tip "Using local models in the chat sidebar or Agent node?"
    ...
    If you want to use Ollama or LM Studio as the AI provider for the **chat sidebar** or an **Agent node** directly, see [AI Providers](../ai_providers.md). That's the simpler path for most use cases.
